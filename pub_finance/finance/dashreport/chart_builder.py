    ...
    def __init__(self):
        self.theme_config = {
            "light": {
                ...
                "upgrade-marker-color": "#475A76",
                "total-cnt-color": "#475A76",
                "long": "#ff4444",
                "short": "#0d876d",
                "pnl-colors": [
                    "#FF4444",
        ...
        fig.add_trace(
            go.Table(
                ...
                header=dict(
                    ...
                    line=dict(color=cfg["border-color"], width=0.2),
                    font=dict(
