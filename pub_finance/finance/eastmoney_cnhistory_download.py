...
class EMCNHistoryDataDownload:
    def get_us_stock_list(self):
        ...
        url = (
            ...
            "&pn=i&pz=200&po=1&np=1&ut=&fltt=2&invt=2&fid=f3&fs=m:mkt_code&fields=f2,f3,f4,f5,f6,f7,f12,f14,f15,f16,f17,f18,f20,f21&_=unix_time"
        )
        for mkt_code in ["0", "1"]:
            """请求url，获取数据response"""
...
start_date = "20240101"
end_date = "20241231"
file_path = "./cnstockinfo/stock_20241231.csv"
