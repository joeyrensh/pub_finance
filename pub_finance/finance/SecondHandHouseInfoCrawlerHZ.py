...
def houseinfo_to_csv(file_path):
    ...
    complete_list = []
    count = 0
    url = ("https://hz.lianjia.com/xiaoqu/district/pgpgnocro21/")
    for idx, district in enumerate(district_list):                
        ...
        data_batch_size = 10
        list = []
        url_detail = 'https://hz.lianjia.com/xiaoqu/data_id/'
        t = ToolKit("信息爬取")
...
if __name__ == "__main__":
    ...
    png_path_by_district = './houseinfo/hzmap_second_bydistrict.png'
    png_path_by_street = './houseinfo/hzmap_second_bystreet.png'
