...
## 界面预览
<div style="display: flex; width: 100%; gap: 1%; justify-content: center; align-items: flex-start; min-height: 220px;">
  <img style="width: 32%; align-self: flex-start;" src="https://github.com/joeyrensh/pub_finance/raw/master/pub_finance/finance/Frontpage.png" alt="回测分析主界面">
  <img style="width: 32%; align-self: flex-start;" src="https://github.com/joeyrensh/pub_finance/raw/master/pub_finance/finance/Backtest.png" alt="买卖点K线分析">
  <img style="width: 32%; align-self: flex-start;" src="https://github.com/joeyrensh/pub_finance/raw/master/pub_finance/finance/Config.png" alt="自定义偏好">
</div>
<p align="center">
