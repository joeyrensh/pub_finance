...
def exec_btstrategy(date):
    ...
    fig, (ax0, ax1) = plt.subplots(
        2, 1, gridspec_kw={"height_ratios": [1, 2]}, figsize=(18, 9)
    )
    ...
    fig.tight_layout()
    plt.savefig("./images/cnetf_tr_light.png", transparent=True)
    # Set the font color of the table cells to white
    for cell in table.get_celld().values():
    ...
    fig.tight_layout()
    plt.savefig("./images/cnetf_tr_dark.png", transparent=True)
