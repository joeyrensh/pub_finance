...
class HouseInfoCrawlerHZ:
    def get_house_info(self):

   
        houselist = []
        filename = './houseinfo/newhousehz.csv'

        # 如果文件存在，则删除文件
        if os.path.isfile(filename):
            os.remove(filename)
        cnt = 0
        district_list = ['shangcheng','gongshu','xihu','binjiang','xiaoshan','yuhang','tonglu1','chunan1','jiande','fuyang','linan','qiantangqu','hangzhouwanxinqu1','linpingqu']
        t = ToolKit("策略执行中")
...
df_new_house = pd.read_csv('./houseinfo/newhousehz.csv', usecols=[
...
html_img = """
        ...
        """
image_path = [
    "./houseinfo/hzmap_bydistrict.png",
    "./houseinfo/hzmap_bystreet.png"
]
