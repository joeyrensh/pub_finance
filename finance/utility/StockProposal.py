...
class StockProposal:
    ...
    def send_btstrategy_by_email(self):
        ...
        sparkdata7 = spark.sql(
            ...
            WITH tmp AS (
                ...
                SELECT t1.industry
                    ...
                    ,COUNT(DISTINCT IF(t2.sell_date >= DATE_ADD('{}', -10), t2.symbol, null)) AS l10_close
            ...
            SELECT t1.industry
                ...
                ,COALESCE(t1.l10_close,0) AS l10_close
        ...
        html = (
            ...
            .background_gradient(
                subset=["PROFIT", "OPEN", "L10 OPEN", "L10 CLOSE"], cmap=cm
            )
            .bar(
                subset=["WIN RATE"],
                align="left",
        ...
        sparkdata3 = spark.sql(
            ...
            WITH tmp1 AS (
                ...
                AND date >= DATE_ADD('{}', -60) AND l_date >= DATE_ADD('{}', -60)
            ),tmp4 AS (
                SELECT date
                    ,SUM(cnt) AS cnt
                FROM (
